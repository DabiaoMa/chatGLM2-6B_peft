...
from peft import AdaptionPromptModel_chatGLM, AdaptionPromptConfig, get_peft_model, LoraConfig, TaskType
...
def main():
    ...
    peft_config = AdaptionPromptConfig(target_modules=None, adapter_len=32, adapter_layers=16)
